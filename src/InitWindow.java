...
public class InitWindow extends Window {
    ...
    public static final RichText.Foundry fnd = new RichText.Foundry(Text.sans.deriveFont(UI.scale(16.5f)), Color.BLACK).aa(true);
    public static final RichText.Foundry nfnd = new RichText.Foundry(Text.sans.deriveFont(UI.scale(25f)), Color.BLACK).aa(true);
