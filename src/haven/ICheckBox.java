...
public class ICheckBox extends Widget {
    ...
    public ICheckBox state(Supplier<Boolean> state) {
        this.state = state;
        return (this);
    }
    ...
    public ICheckBox changed(Consumer<Boolean> changed) {
    ...
    public ICheckBox set(Consumer<Boolean> set) {
        this.set = set;
        return (this);
    }
    ...
    public ICheckBox click(Runnable click) {
        this.click = click;
        return (this);
    }
